...
import com.mohanty.secretdoor.response.DoorResponse;
import com.mohanty.secretdoor.response.DoorResponseCode;
...
public class SecretController {
	...
	@GetMapping
	public ResponseEntity<DoorResponse> openSecretDoor(@RequestParam(name = "code") String code) throws Exception {
		...
		return new SecretDoorResponse().createResponse(message, DoorResponseCode.DOOR_GENERAL_CODE);
